...
public class OI 
{
	public static Joystick driverStickFB = new Joystick(RobotMap.ports[RobotMap.DRIVER_PORT_FB]);
	public static Joystick driverStickRL = new Joystick(RobotMap.ports[RobotMap.DRIVER_PORT_RL]);
